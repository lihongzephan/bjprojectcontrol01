...
class ls {
  ...
  static var listStrings_EN = [
    ...
    { 'Title':'Mode:Auto', 'Content':'Move Mode: Auto'},
    { 'Title':'Mode:Manual', 'Content':'Move Mode: Manual'},
  ...
  static var listStrings_SC = [
    ...
    { 'Title':'Mode:Auto', 'Content':'移动模式：自动'},
    { 'Title':'Mode:Manual', 'Content':'移动模式：手动'},
  ...
  static var listStrings_TC = [
    ...
    { 'Title':'Mode:Auto', 'Content':'移動模式：自動'},
    { 'Title':'Mode:Manual', 'Content':'移動模式：手動'},
